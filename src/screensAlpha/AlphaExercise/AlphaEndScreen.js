...
import EndMap from './components/AlphaEndMap';
import ShareImage from './components/AlphaShareImage';
 ...
 */
const AlphaEndScreen = ({navigation, route}) => {
