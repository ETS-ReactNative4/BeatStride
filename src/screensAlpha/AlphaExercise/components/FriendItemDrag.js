    ...
    return (
        <Animated.View style={animatedStyle}>
            ...
            <TouchableOpacity onPress={() => {
                if (userData!=null){
                  (addedFriendList.some((item)=>{return item.uid==userData.uid}))? setAddedFriendList(addedFriendList.filter(item => item.uid !== userData.uid)):setAddedFriendList([startItem,...addedFriendList]);
                }  }}>
                <Animated.View>
                    <View style={{...styles.componentContainer}}>
                        ...
                        {(addedFriendList.some((item)=>{return item.uid==userData.uid}))?
